...
<body data-spy="scroll" data-target=".site-nav-target" data-offset="200">
  ...
  <div class="unslate_co--site-wrap">
    ...
    <div class="unslate_co--site-inner">
      ...
      <div class="cover-v1 jarallax" style="background-image: url('images/laut.jpg');" id="home-section">
        <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0, 0, 0, 0.5);"></div>
        <div class="container">
          <div class="row align-items-center">

            <div class="col-md-7 mx-auto text-center">
              <h1 class="heading gsap-reveal-hero">Arif Bucholi</h1>
              <h2 class="subheading gsap-reveal-hero">from Airlangga University</h2>
              <!-- <h2 class="subheading gsap-reveal-hero">I’m Muhammad Arif Bucholi</h2> -->
            </div>
          ...
          <div class="portfolio-wrapper">
            ...
            <div id="posts" class="row gutter-isotope-item">
                ...
                <a href="portfolio-single-1.html" class="portfolio-item ajax-load-page isotope-item gsap-reveal-img" data-id="1">
                    <div class="overlay">
                      ...
                      <div class="portfolio-item-content">
                        <h3>Redesign Vespa Web</h3>
                        <p>Figma</p>
                      </div>
                    </div>
                    <img src="images/portfolio/vespa1.png" class="lazyload  img-fluid" alt="Images" />
                  </a>
              </div> -->
              <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">

                <a href="images/portfolio/vespa1.png" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Redesign Vespa">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Redesign Vespa Website</h3>
                      <p>Figma</p>
                    </div>
                  </div>
                  <img src="images/portfolio/vespa1.png" class="lazyload  img-fluid" alt="Images" />
              ...
              <!-- <div class="item branding packaging illustration col-sm-6 col-md-6 col-lg-4 isotope-mb-2 ">
                <a href="portfolio-single-3.html" class="portfolio-item ajax-load-page item-portrait isotope-item gsap-reveal-img" data-id="3">
                    <div class="overlay">
                      <span class="wrap-icon icon-link2"></span>
                      <div class="portfolio-item-content">
                        <h3>Redesign Shopee</h3>
                        <p>Figma</p>
                      </div>
                    </div>
                    <img src="images/portfolio/shopee1.png" class="lazyload  img-fluid" alt="Images" />
                  </a>
              </div> -->
              <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">

                <a href="images/portfolio/shopee1.png" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Redesign Shopee">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Redesign Shopee</h3>
              ...
              <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                ...
                <a href="images/portfolio/ayf1.png" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Redesign AYF">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Redesign AYF</h3>
                  ...
                  <img src="images/portfolio/ayf1.png" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>

              <!-- <div class="item branding packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/ayf1.png" class="portfolio-item isotope-item gsap-reveal-img ajax-load-page" data-id="4">
                    <div class="overlay">
                      <span class="wrap-icon icon-link2"></span>
                      <div class="portfolio-item-content">
                        <h3>Redesign AYF</h3>
              ...
              <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/titanic1.png" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="News Design">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>News Design</h3>
                  ...
                  <img src="images/portfolio/titanic1.png" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>

              <div class="item illustration packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/anjang1.png " class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Website Permits">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Website</h3>
                  ...
                  <img src="images/portfolio/anjang1.png" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>

              <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/peduli1.png" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Website Charity">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Website</h3>
                  ...
                  <img src="images/portfolio/peduli1.png" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>

              <div class="item illustration packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/restaurantDicoding.jpg" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Website Permits">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Native Website</h3>
                      <p>Recommended Restaurant with API</p>
                    </div>
                  </div>
                  <img src="images/portfolio/restaurantDicoding.jpg" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>

              <div class="item illustration packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/portoDicoding.jpg" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Website Permits">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Design</h3>
                  ...
                  <img src="images/portfolio/portoDicoding.jpg" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>

              <div class="item illustration packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/bookshelfDicoding.jpg" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Website Permits">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Website</h3>
                      <p>Bookshelf with API</p>
                    </div>
                  </div>
                  <img src="images/portfolio/bookshelfDicoding.jpg" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>

              <div class="item illustration packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/portfolio/notesDicoding.jpg" class="portfolio-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Website Permits">
                  <div class="overlay">
                    <span class="wrap-icon icon-photo2"></span>
                    <div class="portfolio-item-content">
                      <h3>Website</h3>
                  ...
                  <img src="images/portfolio/notesDicoding.jpg" class="lazyload  img-fluid" alt="Images" />
                </a>
              </div>
          ...
          <div class="row mt-5 justify-content-between">
            <div class="col-lg-7 mb-5 mb-lg-0">
              <figure class="dotted-bg gsap-reveal-img ">
                <img src="images/arifbucholi.jpeg" alt="Image" class="img-fluid">
                <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0, 0, 0, 0.3);"></div>
              </figure>
            </div>
            <div class="col-lg-4 pr-lg-5">
              <h3 class="mb-4 heading-h3"><span class="gsap-reveal">Perkenalkan</span></h3>
              <p class="lead gsap-reveal">Nama saya Muhammad Arif Bucholi, berasal dari Surabaya. Saat ini, saya sedang menempuh pendidikan di Universitas Airlangga dengan jurusan Teknik Informatika.
                <!-- <a href="#">live the blind</a> texts.  -->
              </p>
              <p class="mb-4 gsap-reveal">Saya memiliki minat yang besar dalam teknologi dan pengembangan perangkat lunak.</p>
              <p class="gsap-reveal"><a href="https://sg.docworkspace.com/d/sIJfoms9G58brqwY" class="btn btn-outline-pill btn-custom-light">view resume</a></p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row gutter-v3">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="feature-v1" data-aos="fade-up" data-aos-delay="0">
                ...
                <h3>Fullstack <br> Development</h3>
                <!-- <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. </p> -->
              </div>
            </div>
            <!-- <div class="col-md-6 col-lg-4 mb-4">
        ...
        <div class="container">
          ...
          <div class="row pt-5">
            ...
            <div class="col-6 col-sm-6 mb-5 mb-lg-0 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
              <div class="counter-v1 text-center">
                <span class="number-wrap">
                  <span class="number number-counter" data-number="94">0</span>
                  <span class="append-text">%</span>
                </span>
            ...
            <div class="col-6 col-sm-6 mb-5 mb-lg-0 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
              <div class="counter-v1 text-center">
                ...
                <span class="counter-label">Github</span>
              </div>
            </div>
            <div class="col-6 col-sm-6 mb-5 mb-lg-0 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
              <div class="counter-v1 text-center">
                ...
                <span class="counter-label">Figma</span>
              </div>
            </div>
          </div>
          ...
          <div class="row pt-5">
            ...
            <div class="col-6 col-sm-6 mb-5 mb-lg-0 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
              <div class="counter-v1 text-center">
                <span class="number-wrap">
                  <span class="number number-counter" data-number="92">0</span>
                  <span class="append-text">%</span>
                </span>
            ...
            <div class="col-md-4">
              <div class="contact-info-v1">
                <div class="gsap-reveal d-block">
                  ...
                  <a href="#" class="contact-info-val">muhammad.arif.ma23@gmail.com</a>
                </div>
                <div class="gsap-reveal d-block">
                  <span class="d-block contact-info-label">Phone</span>
                  <a href="#" class="contact-info-val">+62 812 3260 0907</a>
                </div>
                <div class="gsap-reveal d-block">
                  <span class="d-block contact-info-label">Address</span>
                  <address class="contact-info-val">Jl. Bhaskara <br> Surabaya, 60112</address>
                </div>
              </div>
            </div>
        ...
        <div class="row justify-content-center">
          <div class="col-md-7">
            ...
            <div class="footer-site-logo">
              <a href="#">Thank you for looking at my portfolio
                <!-- <span>.</span> -->
              </a>
            </div>
            ...
            <ul class="footer-site-social">
              ...
              <li><a href="https://www.instagram.com/arifbucholi/">Instagram</a></li>
              <li><a href="https://www.linkedin.com/in/muhammad-arif-bucholi-87933529a/">Linkedin</a></li>
            ...
            <p class="site-copyright">
              ...
              This portfolio is made </i> by <a href="" target="_blank">arifbucholi</a>
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
